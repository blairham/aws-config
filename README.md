...
- **Docker**: `docker pull ghcr.io/blairham/aws-sso-config:latest`

For complete installation instructions, troubleshooting, and platform-specific notes, see [INSTALL.md](INSTALL.md).
...
Run with Docker using the ultra-minimal scratch-based image (~5MB):
...
For comprehensive Docker usage, including volume mounts, security considerations, and troubleshooting, see [DOCKER.md](DOCKER.md).
